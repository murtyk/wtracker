...
#
#     @klass1 = FactoryBot.create(:klass, program_id: program.id, college_id: college.id)
#     @klass2 = FactoryBot.create(:klass, program_id: program.id, college_id: college.id)
#
#     @k1_trainees = 3.times.map { FactoryBot.create :trainee }
#     @klass1.trainees << @k1_trainees
#
#     @k2_trainees = 3.times.map { FactoryBot.create :trainee }
